...
- handle prompt metadata persistence cleanly in a Manifest V3 extension
...
NavGPT is a single Chrome extension.
...
- background service worker (minimal MV3 stub)
...
Shows an About section with a link to the GitHub repository.
...
- `src/background.ts` — minimal MV3 service worker stub
